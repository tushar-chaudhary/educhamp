...
import { editParentPassword } from '../../actions/authActions';
import { Redirect } from 'react-router-dom';

class EditParentPassword extends Component {
  constructor() {
    super();
    this.state = {
      currentpassword: '',
  ...
  onSubmit(e) {
    ...
    this.props.editParentPassword(newUser);
  }
...
export default connect(mapStateToProps, { editParentPassword })(
  withRouter(EditParentPassword)
);
